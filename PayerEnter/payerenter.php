...
class plgVmPaymentPayerenter extends vmPSPlugin {
	...
	public function getVmPluginCreateTableSQL() {
		return $this->createTableSQL('Payment Payer Enter Table');
	}
	...
	function plgVmConfirmedOrder($cart, $order) {
		if (!class_exists('payread_post_api')) {
			require_once("plugins/vmpayment/payerenter/payer/payread_post_api.php");
		}
