...
class plgVmPaymentPayerinvoice extends vmPSPlugin {
	...
	public function getVmPluginCreateTableSQL() {
		return $this->createTableSQL('Payment Payer Invoice Table');
	}
	...
	function plgVmConfirmedOrder($cart, $order) {
		if (!class_exists('payread_post_api')) {
			require_once("plugins/vmpayment/payerinvoice/payer/payread_post_api.php");
		}
