...
class plgVmPaymentPayerwywallet extends vmPSPlugin {
	...
	public function getVmPluginCreateTableSQL() {
		return $this->createTableSQL('Payment Payer WyWallet Table');
	}
	...
	function plgVmConfirmedOrder($cart, $order) {
		if (!class_exists('payread_post_api')) {
			require_once("plugins/vmpayment/payerwywallet/payer/payread_post_api.php");
		}
